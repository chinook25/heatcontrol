...
public class Executor implements Watcher, Runnable,
	...
	public Executor(String hostPort, String znode, String filename,
		...
		this.exec = exec;
		zk = new ZooKeeper(hostPort, 3000, this); // hosts sessiontimeout watcher
...
//		System.arraycopy(args, 3, exec, 0, exec.length);
		//http://www.nofluffjuststuff.com/blog/scott_leberknight/2013/07/distributed_coordination_with_zookeeper_part_3_group_membership_example
		String hostPort = "2181";
		String znode = "/rc";
		String filename = "RoomController1";
		String exec[]	= {"RoomController.class", "/roomcontrollers/RoomController1", null};
		try {
